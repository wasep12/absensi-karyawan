            ...
            <div class="main-sidebar bg-dark">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand bg-dark">
                        <a class="text-light" href="/">Absensi RFID</a>
                    </div>
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="/">SKT</a>
                    </div>
                    <ul class="sidebar-menu">
                        <li class="menu-header">Master Data Karyawan</li>
                        <li><a class="nav-link" href="{{url('/karyawan')}}"><i class="fa fa-users"
                                    aria-hidden="true"></i>
                                <span>Data Karyawan</span></a></li>

                        <li class="menu-header">Rekap Absensi</li>
                        <li><a class="nav-link" href="{{url('/absensi')}}"><i class="fa fa-calendar-check-o"
                                    aria-hidden="true"></i>
                                <span>Data Absensi</span></a></li>

                        <li class="menu-header">RFID</li>
                        <li><a class="nav-link" href="{{url('/scan')}}"><i class="fa fa-barcode"
                                    aria-hidden="true"></i><span>Presensi</span></a></li>

                        <li class="menu-header">Pengaturan</li>
                        <li><a class="nav-link" href="{{url('/settings')}}"><i class="fa fa-gear"
                                    aria-hidden="true"></i><span>Setting Absensi</span></a></li>
